...
class yuri_spider(scrapy.Spider):
    ...
    def parse(self, response):
      for i in range(2, 12):
        yield {
            'Ключевое слово' : response.xpath(f'//*[@id="app"]/div[3]/div[4]/div[6]/div/div[2]/div[3]/div/div/div/div/div/div/div/table/tbody/tr[{i}]/td[1]/text()').get(),
            'Позиция' : response.xpath(f'//*[@id="app"]/div[3]/div[4]/div[6]/div/div[2]/div[3]/div/div/div/div/div/div/div/table/tbody/tr[{i}]/td[2]/text()').get(),
            'Показов' : response.xpath(f'//*[@id="app"]/div[3]/div[4]/div[6]/div/div[2]/div[3]/div/div/div/div/div/div/div/table/tbody/tr[{i}]/td[3]/text()').get().replace('&nbsp;', ' '),
            'URL' : response.xpath(f'//*[@id="app"]/div[3]/div[4]/div[6]/div/div[2]/div[3]/div/div/div/div/div/div/div/table/tbody/tr[{i}]/td[4]/a/text()').get()
        }